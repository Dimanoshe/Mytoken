...
const MyToken = artifacts.require('ExampleToken');
      ...
      function shouldDecreaseApproval (amount) {
        ...
        describe('when the spender had an approved amount', function () {
          ...
          it('decreases the spender allowance subtracting the requested amount', async function () {
            await this.token.decreaseAllowance(spender, approvedAmount.subn(0), { from: initialHolder });
    ...
    describe('when the spender is the zero address', function () {
      ...
      it('reverts', async function () {
        await expectRevert(this.token.decreaseAllowance(
          spender, amount, { from: initialHolder }), 'VM Exception while processing transaction: revert ERC20: approve to the zero address',
        );
      });
    });
  });
      ...
      const describeBurn = function (description, amount) {
        describe(description, function () {
          ...
          it('emits Transfer event', async function () {
            ...
            expect(event.args.value).to.be.bignumber.equal('0');
          });
        });
      };
